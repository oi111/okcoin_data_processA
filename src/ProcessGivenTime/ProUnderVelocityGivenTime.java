...
public class ProUnderVelocityGivenTime {
	...
	void process(String inputfile, int limit, int bin, int cc, int kk, int ll, int tt) {
		this.KK = kk;
		this.TT = tt;
		this.LL = ll;
		this.BIN = bin;
		...
		input.closeFile();
		outputData("ProUnderVelocityGivenTime_T" + TT + "B" + this.BIN + "C" + this.CC + "K" + this.KK + "L" + LL);
		outputPro("ProUnderVelocityGivenTime_T" + TT + "B" + this.BIN + "C" + this.CC + "K" + this.KK + "L" + LL);
	}

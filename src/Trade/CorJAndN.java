...
public class CorJAndN {
	...
	TCor tc1 = new TCor(), tc2 = new TCor();

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		CorJAndN pu = new CorJAndN();
	...
	void process(String inputfile, String tradefile, int limit, int vbin, int vlen) {
		...
		System.out.println(tc1.calCorrelation() + " " + tc2.calCorrelation());
	}
	...
	void processX(StrOrder p1, StrOrder p2) {
		...
		if (p1.time / 1000 - p2.time / 1000 == 1 && hm.containsKey(p2.time / 1000)) {
			...
			// ld1.add(t1);
			// ld2.add(t0 - t1);
			tc1.add(t0 - t1, (p1.t1 + p1.t2) / 1000.0);
			tc2.add(t0 - t1, (p2.t1 + p2.t2) / 1000.0);
			for (int i = 0; i < 10; i++) {
